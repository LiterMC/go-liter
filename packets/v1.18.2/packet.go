...
func (p *PlaySpawnLivingEntityPkt)DecodeFrom(r *PacketReader)(err error){
	var ok bool
...
func (p *PlayFacePkt)DecodeFrom(r *PacketReader)(err error){
	var ok bool
...
func (p *PlayEntityEffectPkt)DecodeFrom(r *PacketReader)(err error){
	var ok bool
	if p.EntityID, ok = r.VarInt(); !ok {
		return io.EOF
	}
