...
type PlayClickWindowPkt struct {
	 ...
	 * | 0x08      | Play  | Server   | Carried item        | Carried item        | Slot          | Slot          | Item carried by the cursor. Has to be empty (item ID = -1) for drop mode, otherwise nothing will happen. |
	 * 
	 */
}
...
func (p *PlayEditBookPkt)DecodeFrom(r *PacketReader)(error){
	var ok bool
	_ = ok
	var err error
	_ = err
...
// ID=0x2
type PlaySpawnLivingEntityPkt struct {
...
var _ Packet = (*PlaySpawnLivingEntityPkt)(nil)

func (p PlaySpawnLivingEntityPkt)Encode(b *PacketBuilder){
	b.VarInt(p.EntityID)
	b.UUID(p.EntityUUID)
	b.VarInt(p.Type)
	b.Double(p.X)
...
func (p *PlaySpawnLivingEntityPkt)DecodeFrom(r *PacketReader)(error){
	var ok bool
	_ = ok
	var err error
	_ = err
...
// ID=0x22
type PlayChunkDataAndUpdateLightPkt = internal.PlayChunkDataAndUpdateLight_758_5
...
// ID=0x25
type PlayUpdateLightPkt = internal.PlayUpdateLight_758_5

// ID=0x26
type PlayJoinGamePkt = internal.PlayJoinGame_758_0

// ID=0x27
type PlayMapDataPkt = internal.PlayMapData_758_4
...
var _ Packet = (*PlayFacePkt)(nil)

func (p PlayFacePkt)Encode(b *PacketBuilder){
...
func (p *PlayFacePkt)DecodeFrom(r *PacketReader)(error){
	var ok bool
	_ = ok
	var err error
	_ = err
...
// ID=0x3d
type PlayRespawnPkt = internal.PlayRespawn_758_4
...
// ID=0x63
type PlayAdvancementsPkt = internal.PlayAdvancements_758_0

// ID=0x64
type PlayEntityPropertiesPkt = internal.PlayEntityProperties_758_0
...
var _ Packet = (*PlayEntityEffectPkt)(nil)

func (p PlayEntityEffectPkt)Encode(b *PacketBuilder){
	b.VarInt(p.EntityID)
	b.VarInt(p.EffectID)
	b.Byte(p.Amplifier)
	b.VarInt(p.Duration)
...
func (p *PlayEntityEffectPkt)DecodeFrom(r *PacketReader)(error){
	var ok bool
	_ = ok
	var err error
	_ = err
...
// ID=0x66
type PlayDeclareRecipesPkt = internal.PlayDeclareRecipes_758_0

// ID=0x67
type PlayTagsPkt = internal.PlayTags_758_0
